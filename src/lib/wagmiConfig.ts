  ...
  [
    {
      ...
      wallets: [metaMaskWallet, trustWallet, coinbaseWallet, phantomWallet, okxWallet],
    },
    {
      groupName: "Other",
...
export const wagmiConfig = createConfig({
  ...
  connectors,
  transports: {
    [ariesChain.id]: http(process.env.NEXT_PUBLIC_ARIES_RPC_URL || "https://rpc.arieschain.org"),
  },
  ssr: true,
});
