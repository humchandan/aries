          ...
          <div className="space-y-2 rounded-md border bg-muted/20 px-3 py-2">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center justify-between gap-2 rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground tabular-nums">4 deals · {formatCurrency(478000)}</span>
              </div>
              ...
              <div className="flex items-center justify-between gap-2 rounded-md border bg-background/70 px-2.5 py-1.5">
                ...
                <span className="text-muted-foreground tabular-nums">8 deals · {formatCurrency(1151000)}</span>
              </div>
            </div>
          </div>
