...
export default function RevolutLanding() {
  ...
  const [referrer, setReferrer] = useState("0xd01c1bfc96e22a9470c186e69e0a97e18eff23e6");
  ...
  useEffect(() => {
    if (userAddress && (userProfile || isAdmin)) {
      // Admin or registered user → go straight to dashboard
      router.push("/dashboard");
    } else if (userAddress && !userProfile && !isAdmin) {
      // Unregistered non-admin → show registration modal
      setShowRegModal(true);
    }
  }, [userAddress, userProfile, isAdmin, router]);
  ...
  const featureTabs = [
    {
      ...
      visual: (
        <div style={{ background: "#0d0e12", borderRadius: 16, padding: 24, border: "1px solid #1a1c24" }}>
          <div
            style={{ fontSize: 11, color: "#6b7280", textTransform: "uppercase", letterSpacing: 1, marginBottom: 16 }}
          >
            Active Node Yield
          </div>
          {[
            ["Bronze Node", "1,000 ARES", "83 ARES/mo"],
            ["Silver Node", "5,000 ARES", "416 ARES/mo"],
            ["Gold Node", "10,000 ARES", "833 ARES/mo"],
          ].map(([tier, stake, yield_]) => (
            <div
              key={tier}
              style={{
                display: "flex",
        ...
        <div style={{ background: "#0d0e12", borderRadius: 16, padding: 24, border: "1px solid #1a1c24" }}>
          ...
          >
            <span style={{ fontSize: 12, color: "#a78bfa" }}>
              <i className="fa-solid fa-certificate" /> NFT Minted
            </span>
  ...
  const projects = [
    {
      ...
      bullets: [
        "Pay once in ARES — own your images forever",
        "Instagram & photo library integration",
        "Immutable on-chain storage via IPFS",
        "Shareable family tree viewer link",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Works as a browser extension overlay",
        "Real-time on-screen tip alerts",
        "0% platform cut — 100% to creators",
        "Viewer leaderboard & tipping history",
      ],
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={logoImg.src} alt="Aries logo" style={{ height: "24px", width: "auto" }} />
          <span>
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: 8,
            border: "1px solid rgba(25,112,255,0.3)",
            borderRadius: 9999,
            padding: "6px 16px",
            marginBottom: 32,
            background: "rgba(25,112,255,0.06)",
          }}
        >
          <span
            style={{
          ...
          />
          <span style={{ fontSize: 13, color: "#60a5fa", fontWeight: 600, letterSpacing: 0.5 }}>
            Aries Blockchain — Mainnet Live
          </span>
        </div>
        ...
        >
          Aries is a next-generation blockchain built for speed, utility, and real-world adoption — with near-zero fees,
          NFT minting, creator payments, and on-chain bill settlements.
        </p>
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", marginBottom: 80 }}>
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = "#3888ff";
              e.currentTarget.style.transform = "translateY(-2px)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = "#1970ff";
      ...
      <section id="why" style={{ padding: "100px 24px", maxWidth: 1140, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 72 }}>
          ...
          >
            Everything Ethereum promised.
            <br />
            Actually delivered.
          </h2>
          <p style={{ color: "rgba(255,255,255,0.45)", fontSize: 18, maxWidth: 560, margin: "0 auto" }}>
            We built Aries from first principles — removing the bottlenecks that prevent crypto from reaching everyday
            people.
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 20 }}>
          {whyAres.map((item, i) => (
            ...
            >
              ...
              <h3 style={{ fontFamily: "'Outfit', sans-serif", fontSize: 20, fontWeight: 700, marginBottom: 10 }}>
                {item.title}
              </h3>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ border: "1px solid rgba(255,255,255,0.07)", borderRadius: 20, overflow: "hidden" }}>
            ...
            >
              ...
              <div style={{ fontSize: 14, fontWeight: 600, color: "rgba(255,255,255,0.3)", textAlign: "center" }}>
                Ethereum
              </div>
            </div>
            {/* Rows */}
            {[
              ...
              <div
                ...
                style={{
                  ...
                  background: i % 2 === 0 ? "#080809" : "#0a0a0a",
                }}
              >
                ...
                <div style={{ fontSize: 14, fontWeight: 500, color: "rgba(255,255,255,0.3)", textAlign: "center" }}>
                  {eth}
                </div>
              </div>
            ))}
        ...
        >
          <div>
            <div
              style={{
                display: "inline-block",
                background: featureTabs[activeTab].badgeColor + "20",
                color: featureTabs[activeTab].badgeColor,
                padding: "4px 14px",
                borderRadius: 9999,
                fontSize: 12,
                fontWeight: 700,
                marginBottom: 20,
                border: `1px solid ${featureTabs[activeTab].badgeColor}40`,
              }}
            >
              ...
              >
                ...
                <div style={{ padding: 48 }}>
                  ...
                  <div
                    style={{
                      ...
                      height: 56,
                      borderRadius: 16,
                      background: proj.accentColor + "20",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      marginBottom: 20,
                  ...
                  <div style={{ fontSize: 16, color: proj.accentColor, fontWeight: 600, marginBottom: 20 }}>
                    {proj.subtitle}
                  </div>
                ...
                <div
                  style={{
                    ...
                    display: "flex",
                    alignItems: "center",
                    borderLeft: `1px solid ${proj.accentColor}15`,
                  }}
                >
                  <div style={{ width: "100%" }}>
                    <div
      ...
      <section style={{ padding: "120px 24px", textAlign: "center", background: "#000" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 18, marginBottom: 44, lineHeight: 1.6 }}>
            Connect your MetaMask, register your node, and start earning staking yields and matching rewards
            immediately.
          </p>
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.07)", padding: "48px 24px", background: "#000" }}>
        ...
        >
          ...
          <div style={{ fontSize: 13, color: "rgba(255,255,255,0.2)" }}>
            © {new Date().getFullYear()} Aries Protocol
          </div>
        </div>
      </footer>
          ...
          >
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 14, lineHeight: 1.6 }}>
                Complete your profile to join the Aries network and start earning staking rewards.
              </p>
            </div>
            ...
            {[
              ...
              <div key={f.label} style={{ marginBottom: 20 }}>
                ...
                <input
                  ...
                  onFocus={(e) =>
                    ((e.currentTarget as HTMLInputElement).style.border = "1px solid rgba(25,112,255,0.6)")
                  }
                  onBlur={(e) =>
                    ((e.currentTarget as HTMLInputElement).style.border = "1px solid rgba(255,255,255,0.1)")
                  }
                />
              </div>
            ))}
